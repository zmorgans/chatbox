...
export default function Home() {
  ...
  const personas = [
    { id: "academic", name: "Academic Scholar", desc: "Uses research, citations, and formal logic" },
    { id: "lawyer", name: "Courtroom Lawyer", desc: "Cross-examines and pokes holes in arguments" },
    { id: "philosopher", name: "Philosopher", desc: "Questions assumptions and explores ethics" },
    { id: "journalist", name: "Investigative Journalist", desc: "Fact-checks and challenges with evidence" },
    { id: "devil", name: "Devil's Advocate", desc: "Aggressively challenges every point" },
    { id: "socratic", name: "Socratic Mentor", desc: "Uses questions to expose weaknesses" },
  ];
  ...
  const handleStartDebate = () => {
    ...
    if (!persona) {
      alert("Please select an AI persona");
      return;
    }

    navigate(createPageUrl("Debate"), {
      state: { topic: topic.trim(), stance, persona }
    });
  };
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <Card className="bg-gray-800 border-gray-700 mb-8">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            <Label className="text-gray-200">AI Opponent Persona</Label>
